package ml_assn4.maze_generation;
...
// https://github.com/gajduk/text-maze-generation
public class Maze {
    Random randGenerator = new Random(Main.SEED);
    ...
    private void generate() {
        ...
        for ( int q = 0 ; q < maze.length*maze[0].length-1 ; ++q ) {
            int pos = (int) (randGenerator.nextDouble()*queue.size());
            ...
            pos = (int) (randGenerator.nextDouble()*stack.size());
